# Jangan Lupa Subscribe Firzz Tutorial :)
...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Subrek VINDRA DOANG Tutorial Slurr, Gk Subrek Gk Kawan")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/channel/UCM-cfD_JtnbfAUbMwApEzVQ")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   ╚═╝┴  ┴ ┴┴ ┴     ╚═╝└─┘└┴┘")
    print ("")
    print ("    > Author  : VINDRA 24 ")
    print ("    > YouTube : VINDRA DOANG ")
    print ("    > Github  : github.com/vindra24 ")
    print ("")
    print ("    > Status Otp : online")
    print ("    > Version : 1.6")
    print ("")
    print ("    1 . Spam Sms  ")
    print ("    2 . Spam Call  ")
    print ("    3 . Spam Whatsapp  ")
    print ("")
    mr_dark_input()
